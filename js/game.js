    ...
    play(){
                ...
                player.getPlayerAtEnd();
                 ...
                 for(var plr in allPlayers){
                     ...
                     //text to display pl ayers score
                         textSize(25);
                         fill("white");
                ...
                if (keyIsDown(LEFT_ARROW) && player.index !== null) {
                 ...
                 //fill code here to destroy the objects.(use th eone  in the class  project 39)
                 //add the condition to calculate the score ,and the use update t1 update  the value  in the  database
